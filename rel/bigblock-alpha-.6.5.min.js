...
if(BigBlock.user_agent.search("ipad")>-1)BigBlock.is_ipad=!0;if(window.navigator.standalone)BigBlock.standalone=!0;BigBlock.ready=function(){BigBlock.Timer.play()};Math.degreesToRadians=function(a){return Math.PI/180*a};Math.radiansToDegrees=function(a){return 180/Math.PI*a};Math.getRandomNumber=function(a,b){return Math.floor(Math.random()*(b-(a-1)))+a};Math.getDistanceBwTwoPts=function(a,b,c,e){return Math.sqrt(Math.pow(c-a,2)+Math.pow(e-b,2))};
...
a}catch(d){BigBlock.Log.display(d.name+": "+d.message)}}},mute:function(){var b;if(this.supported){for(b in this.playlist)if(this.playlist.hasOwnProperty(b))try{this.playlist[b].muted=!0}catch(a){BigBlock.Log.display(a.name+": "+a.message)}this.muted=!0}},unmute:function(){var a;if(this.supported){for(a in this.playlist)if(this.playlist.hasOwnProperty(a))try{this.playlist[a].muted=!1}catch(c){BigBlock.Log.display(c.name+": "+c.message)}this.muted=!1}}}}();
...
BigBlock.Log=function(){var a;a=typeof console!=="undefined"&&typeof console.log!=="undefined"?function(a){console.log(a)}:function(){};typeof window.opera!=="undefined"&&(a=function(a){window.opera.postError(a)});return{timer_enabled:!1,count_enabled:!1,display:a,time:typeof console!=="undefined"&&typeof console.time!=="undefined"?function(a){this.timer_enabled&&console.time(a)}:function(){},timeEnd:typeof console!=="undefined"&&typeof console.timeEnd!=="undefined"?function(a){this.timer_enabled&&
console.timeEnd(a)}:function(){},count:typeof console!=="undefined"&&typeof console.count!=="undefined"?function(a){this.count_enabled&&console.count(a)}:function(){},table:typeof console!=="undefined"&&typeof console.table!=="undefined"?function(a,c){console.table(a,c)}:function(){},error:function(a){return BigBlock.Log.display(a.name.toUpperCase()+" line: "+a.lineNumber+" "+a.message)}}}();
