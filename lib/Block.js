/**
 * Block
 * A generic object that carries core sprite properties. All sprites appearing in a scene should inherit from the Block object.
 * 
 * IMPORTANT: BlockAnim's should not carry action_inputs; if they do, only the top left block of the sprite will trigger the action.
...
BigBlock.Block = (function () {
	...
	return {
		configure: function(){
			...
			this.index = BigBlock.Blocks.length; // the position of this object in the Blocks array
			 ...
			 * to kill the sprite, first set = 0, then call destroy()
			 * 
			 */
