...
BigBlock.Timer = (function () {
	...
	return {
		...
		play : function(params) { // called after all objects are ready
			...
			i = document.createElement('style'); // add core style sheet
		...
		add_char_loader : function () {
			...
			i = document.createElement('style'); // add color style sheet
			i.setAttribute('type', 'text/css');
		...
		add_grid_loader : function () {
			...
			i = document.createElement('style'); // add a style sheet node to the head element to hold grid styles
			i.setAttribute('type', 'text/css');
