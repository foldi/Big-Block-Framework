	...
	return {
		...
		play : function(params) { // called after all objects are ready
			...
			BigBlock.GridInit.configure({
					'quads': [
						{'id' : 'qI_tl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : -100}, 
						{'id' : 'qI_tr', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : -100}, 
						{'id' : 'qI_bl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : (0 + grid_top_offset), 'zIndex' : -100}, 
						{'id' : 'qI_br', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : (0 + grid_top_offset), 'zIndex' : -100}
					]
			});
			...
			BigBlock.GridActive.configure({
					'quads': [
						{'id' : 'qA_tl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : 10}, 
						{'id' : 'qA_tr', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : 10}, 
						{'id' : 'qA_bl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : (0 + grid_top_offset), 'zIndex' : 10}, 
						{'id' : 'qA_br', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : (0 + grid_top_offset), 'zIndex' : 10}
					],
					'styles' : qA_styles
			});
			...
			BigBlock.GridStatic.configure({
					'quads': [
						{'id' : 'qS_tl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : -10}, 
						{'id' : 'qS_tr', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : -10}, 
						{'id' : 'qS_bl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : (0 + grid_top_offset), 'zIndex' : -10}, 
						{'id' : 'qS_br', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : (0 + grid_top_offset), 'zIndex' : -10}
					],
			...
			BigBlock.GridText.configure({
					'quads': [
						{'id' : 'qT_tl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : 1}, 
						{'id' : 'qT_tr', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : ((BigBlock.Grid.height/2) + grid_top_offset), 'zIndex' : 1}, 
						{'id' : 'qT_bl', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : BigBlock.Grid.width/2, 'top' : (0 + grid_top_offset), 'zIndex' : 1}, 
						{'id' : 'qT_br', 'width': BigBlock.Grid.width/2, 'height': BigBlock.Grid.height/2, 'left' : 0, 'top' : (0 + grid_top_offset), 'zIndex' : 1}
					],
			...
			BigBlock.GridBG.configure({
					'quads': [
						{'id' : 'GBG', 'width': BigBlock.Grid.width, 'height': BigBlock.Grid.height, 'left' : BigBlock.Grid.width, 'top' : BigBlock.Grid.height, 'zIndex' : -20}
					],
