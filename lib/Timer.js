...
BigBlock.Timer = (function () {
	...
	return {
		...
		cleanUpBlocks : function () {
			...
			for (var i = 0; i < this.blocks_to_destroy.length; i++) { // loop thru Timer.blocks_to_destroy and remove Blocks
				...
				for (var y = 0; y < BigBlock.BlocksKeys.length; y++) { // delete the Block obj's key
		...
		frameRateTest : function () {
			...
			if (this.clock%this.frame_rate_test_interval == 0) {
				total_time = 0;
				for (var t = 0; t < this.frame_rate_test_interval; t++) {
		...
		runRateTest : function () {
			...
			if (this.clock%this.frame_rate_test_interval == 0) {
				total_time = 0;
				for (var t = 0; t < this.run_rate_test_array.length; t++) {
