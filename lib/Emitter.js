...
BigBlock.Emitter = (function () {
	...
	return {
		...
		create: function (params) {
			var emitter = BigBlock.clone(BigBlock.Block);  // CLONE Block
			emitter.configure(); // run configure() to inherit Block properties
			...
			emitter.action_render = function () {};
			...
			BigBlock.Blocks[BigBlock.Blocks.length] = emitter;
