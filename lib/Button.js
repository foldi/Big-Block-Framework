		...
		create: function (params) {
			...
			try {
				...
				if (typeof(params.action_input) == 'undefined') {
					params.action_input = function () {}; // force an empty function if action_input is not passed
				}
				if (typeof(params.alias) == 'undefined') {
					params.alias = "button" + BigBlock.getUniqueId(); // force alias if alias is not passed
				}																														
			} catch(e) {
			...
			BigBlock.BlockAnim.create(params);
